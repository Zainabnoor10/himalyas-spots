...
class BankAndAtmShogran extends StatefulWidget {
  const BankAndAtmShogran({Key? key}) : super(key: key);

  @override
  State<BankAndAtmShogran> createState() => _BankAndAtmShogranState();
}

class _BankAndAtmShogranState extends State<BankAndAtmShogran> {
  @override
                      ...
                      Column(
                        ...
                        children: [
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                Text("Askari Bank",style: TextStyle(
                                  fontSize: 25,
                                  color: Colors.black,
                      ...
                      Column(
                        ...
                        children: [
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                Text("Askari Bank and ATM",style: TextStyle(
                                  fontSize: 25,
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                ),),
